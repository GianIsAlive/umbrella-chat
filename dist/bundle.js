...
function LargeText(_ref) {
  ...
  return _react2.default.createElement(
    'h2',
    { className: 'large-text ' + className },
    content
  );
}
...
function MediumText(_ref) {
  var content = _ref.content,
      className = _ref.className;

  return _react2.default.createElement(
    'p',
    { className: 'medium-text ' + className },
    content
  );
}
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(14),A=__webpack_require__(4),B=__webpack_require__(3),ca=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),ha=__webpack_require__(18),ia=__webpack_require__(19),C=__webpack_require__(6);
...
var _ChatDirectory = __webpack_require__(82);

var _ChatDirectory2 = _interopRequireDefault(_ChatDirectory);

var _ChatBox = __webpack_require__(90);
...
function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_ChatDirectory2.default, null)
    ),
    _react2.default.createElement(
      'section',
...
var _SideBarMenuItem = __webpack_require__(73);
...
var SideBarMenu = (0, _reactRedux.connect)(mapStateToProps)(_SideBarMenuItem2.default);
...
var _SideBarMenuAction = __webpack_require__(74);

var _RoundButton = __webpack_require__(75);

var _RoundButton2 = _interopRequireDefault(_RoundButton);

var _homeIcon = __webpack_require__(77);

var _homeIcon2 = _interopRequireDefault(_homeIcon);

var _botIcon = __webpack_require__(78);

var _botIcon2 = _interopRequireDefault(_botIcon);

var _notificationIcon = __webpack_require__(79);

var _notificationIcon2 = _interopRequireDefault(_notificationIcon);

var _calendarIcon = __webpack_require__(80);

var _calendarIcon2 = _interopRequireDefault(_calendarIcon);

var _inviteIcon = __webpack_require__(81);

var _inviteIcon2 = _interopRequireDefault(_inviteIcon);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function SideBarItem(_ref) {
  var homeButtonState = _ref.homeButtonState,
      botButtonState = _ref.botButtonState,
      notificationButtonState = _ref.notificationButtonState,
      calendarButtonState = _ref.calendarButtonState,
      inviteButtonState = _ref.inviteButtonState,
      dispatch = _ref.dispatch;

  return _react2.default.createElement(
    'menu',
    { className: 'sidebar-menu' },
    _react2.default.createElement(_RoundButton2.default, {
      buttonName: 'sb-home',
      buttonImg: 'dist/' + _homeIcon2.default,
      buttonState: homeButtonState,
      onClick: function onClick() {
        dispatch((0, _SideBarMenuAction.toggleHomeButton)('active'));
      }
    }),
    _react2.default.createElement(_RoundButton2.default, {
      buttonName: 'sb-bot',
      buttonImg: 'dist/' + _botIcon2.default,
      buttonState: botButtonState,
      onClick: function onClick() {
        dispatch((0, _SideBarMenuAction.toggleBotButton)('active'));
      }
    }),
    _react2.default.createElement(_RoundButton2.default, {
      buttonName: 'sb-notification',
      buttonImg: 'dist/' + _notificationIcon2.default,
      buttonState: notificationButtonState,
      onClick: function onClick() {
        dispatch((0, _SideBarMenuAction.toggleNotificationButton)('active'));
      }
    }),
    _react2.default.createElement(_RoundButton2.default, {
      buttonName: 'sb-calendar',
      buttonImg: 'dist/' + _calendarIcon2.default,
      buttonState: calendarButtonState,
      onClick: function onClick() {
        dispatch((0, _SideBarMenuAction.toggleCalendarButton)('active'));
      }
    }),
    _react2.default.createElement(_RoundButton2.default, {
      buttonName: 'sb-invite',
      buttonImg: 'dist/' + _inviteIcon2.default,
      buttonState: inviteButtonState,
      onClick: function onClick() {
        dispatch((0, _SideBarMenuAction.toggleInviteButton)('active'));
      }
    })
  );
}
...
SideBarItem.propTypes = {
  homeButtonState: _propTypes2.default.string.isRequired,
  botButtonState: _propTypes2.default.string.isRequired,
  notificationButtonState: _propTypes2.default.string.isRequired,
  calendarButtonState: _propTypes2.default.string.isRequired,
  inviteButtonState: _propTypes2.default.string.isRequired,
...
var toggleHomeButton = exports.toggleHomeButton = function toggleHomeButton(buttonState) {
  return {
...
var toggleBotButton = exports.toggleBotButton = function toggleBotButton(buttonState) {
  return {
...
var toggleNotificationButton = exports.toggleNotificationButton = function toggleNotificationButton(buttonState) {
  return {
...
var toggleCalendarButton = exports.toggleCalendarButton = function toggleCalendarButton(buttonState) {
  return {
...
var toggleInviteButton = exports.toggleInviteButton = function toggleInviteButton(buttonState) {
  return {
...
function RoundButton(_ref) {
  var buttonName = _ref.buttonName,
      buttonImg = _ref.buttonImg,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('img', { src: buttonImg, alt: buttonName + ' button' })
  );
}
...
RoundButton.propTypes = {
  buttonName: _propTypes2.default.string.isRequired,
  buttonImg: _propTypes2.default.string.isRequired,
  buttonState: _propTypes2.default.string.isRequired,
...
module.exports = __webpack_require__.p + "./img/home-icon.svg";

/***/ }),
/* 78 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "./img/bot-icon.svg";

/***/ }),
/* 79 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "./img/notification-icon.svg";

/***/ }),
/* 80 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "./img/calendar-icon.svg";

/***/ }),
/* 81 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "./img/invite-icon.svg";
...
var _ChatDirectoryAction = __webpack_require__(83);

var _ChatDirectoryItem = __webpack_require__(84);

var _ChatDirectoryItem2 = _interopRequireDefault(_ChatDirectoryItem);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return dispatch((0, _ChatDirectoryAction.getInformation)());
};

var ChatDirectory = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ChatDirectoryItem2.default);

exports.default = ChatDirectory;
...
var getInformation = exports.getInformation = function getInformation() {
  return {
    ...
    teamChatMembers: ['Grey Sloan Memorial', 'Westside Radiology', 'Goodwill Dermatology'],
    messengers: ['Meredith Grey (You)', 'Izzie Stevens', 'Anne Chambers (patient)']
  };
};

var getChannelHistory = exports.getChannelHistory = function getChannelHistory() {
  return {
    isSelected: true
  };
};
...
var _ExtraLargeText = __webpack_require__(85);

var _ExtraLargeText2 = _interopRequireDefault(_ExtraLargeText);

var _LargeText = __webpack_require__(29);

var _LargeText2 = _interopRequireDefault(_LargeText);

var _MediumText = __webpack_require__(30);

var _MediumText2 = _interopRequireDefault(_MediumText);
...
// import component
// import module
function ChatDirectoryItem(_ref) {
  var companyName = _ref.companyName,
      teamChatMembers = _ref.teamChatMembers,
      messengers = _ref.messengers;

  var teamChatMembersMap = teamChatMembers.map(function (member, index) {
    return _react2.default.createElement(
      'a',
      { href: '#', key: index.toString() },
      _react2.default.createElement(_MediumText2.default, { content: member, key: index.toString() })
    );
  });
  var messengersMap = messengers.map(function (messenger, index) {
    return _react2.default.createElement(
      'a',
      { href: '#', key: index.toString() },
      _react2.default.createElement(_MediumText2.default, { content: messenger, key: index.toString() })
    );
  });
  return _react2.default.createElement(
    'section',
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_ExtraLargeText2.default, { content: companyName })
    ),
    _react2.default.createElement(
      'div',
      { className: 'organization-name' },
      _react2.default.createElement(_LargeText2.default, { content: 'Team Chat Rooms:' }),
      teamChatMembersMap
    ),
    _react2.default.createElement(
      'div',
      { className: 'messenger-name' },
      _react2.default.createElement(_LargeText2.default, { content: 'Direct Message:' }),
      messengersMap
    )
  );
}
...
ChatDirectoryItem.propTypes = {
  ...
  teamChatMembers: _propTypes2.default.arrayOf(_propTypes2.default.string.isRequired),
  messengers: _propTypes2.default.arrayOf(_propTypes2.default.string.isRequired)
};

exports.default = ChatDirectoryItem;
...
function ExtraLargeText(_ref) {
  var content = _ref.content,
      className = _ref.className;

  return _react2.default.createElement(
    'h1',
    { className: 'e-large-text ' + className },
    content
  );
}
...
exports.default = ExtraLargeText;
...
var _ChatBoxItem = __webpack_require__(91);
...
var ChatBox = (0, _reactRedux.connect)(mapStateToProps)(_ChatBoxItem2.default);
...
var _SmallText = __webpack_require__(92);

var _SmallText2 = _interopRequireDefault(_SmallText);

var _ExtraSmallText = __webpack_require__(94);

var _ExtraSmallText2 = _interopRequireDefault(_ExtraSmallText);

var _ChatBoxAction = __webpack_require__(96);

var _InputField = __webpack_require__(97);

var _InputField2 = _interopRequireDefault(_InputField);

__webpack_require__(99);

var _meredith_grey_small = __webpack_require__(100);

var _meredith_grey_small2 = _interopRequireDefault(_meredith_grey_small);

var _renee_collier = __webpack_require__(123);

var _renee_collier2 = _interopRequireDefault(_renee_collier);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// image
function ChatBoxItem(_ref) {
  ...
  var messagesMap = messages.map(function (msg, idx) {
    return _react2.default.createElement(
      'div',
      { className: 'message-container', key: idx.toString() },
      _react2.default.createElement(
        'div',
        { className: 'messenger-info' },
        _react2.default.createElement(
          'div',
          { className: 'messenger-profile-photo' },
          _react2.default.createElement('img', { src: 'dist/' + _meredith_grey_small2.default, alt: 'meredith grey' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'messenger' },
          _react2.default.createElement(_SmallText2.default, { content: msg.messenger })
        ),
        _react2.default.createElement(
          'div',
          { className: 'message-time' },
          _react2.default.createElement(_ExtraSmallText2.default, { content: msg.time })
        )
      ),
      _react2.default.createElement(
        'div',
        { className: 'message-content' },
        _react2.default.createElement(_MediumText2.default, { content: msg.content })
      )
    );
  });
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_LargeText2.default, { content: 'Grey Sloan Memorial, 26 Members' })
    ),
    _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_MediumText2.default, {
          className: 'post-date',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'messenger-profile-photo' },
              _react2.default.createElement('img', { src: 'dist/' + _renee_collier2.default, alt: 'meredith grey' })
            ),
            _react2.default.createElement(
              'div',
              { className: 'messenger' },
              _react2.default.createElement(_SmallText2.default, { content: 'Renee Collier' })
            ),
            _react2.default.createElement(
              'div',
              { className: 'message-time' },
              _react2.default.createElement(_ExtraSmallText2.default, { content: dateObj.toLocaleTimeString() })
            )
          ),
          _react2.default.createElement(
            'div',
            { className: 'message-content' },
            _react2.default.createElement(_MediumText2.default, { content: 'Hello Kim, I\u2019m Renee, Dr. Grey\u2019s AI assistant. Our conversation is monitored by Dr. Grey. How can I help you today?' })
          )
        ),
        messagesMap,
        messages.length >= 1 && _react2.default.createElement(
          'div',
          { className: 'message-container' },
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'message-content' },
            _react2.default.createElement(_MediumText2.default, { content: 'Sore throat is usually caused by common cold virus. The best medicine is rest and laughter. But if you have persistent, severe fever, or swollen glands, you should make an appointment and see Dr. Grey as soon as possible.' })
          )
        )
      )
    ),
      ...
      _react2.default.createElement(
        'form',
        {
          onSubmit: function onSubmit(e) {
            e.preventDefault();
            dispatch((0, _ChatBoxAction.postMessage)(message));
          }
        },
        _react2.default.createElement(_InputField2.default, {
          ...
          onChange: function onChange(e) {
            ...
            dispatch((0, _ChatBoxAction.writeMessage)('Meredith Grey', e.target.value, time));
          }
        })
      )
    )
...
ChatBoxItem.propTypes = {
  message: _propTypes2.default.shape({
    messenger: _propTypes2.default.string,
...
function ExtraSmallText(_ref) {
  var content = _ref.content,
      className = _ref.className;

  return _react2.default.createElement(
    'p',
    { className: 'e-small-text ' + className },
    content
  );
}
...
exports.default = ExtraSmallText;
...
var displayCurrentTime = exports.displayCurrentTime = function displayCurrentTime() {
  return {
...
var writeMessage = exports.writeMessage = function writeMessage(messenger, content, time) {
  return {
    type: 'WRITE_MESSAGE',
    message: {
      messenger: messenger,
...
module.exports = __webpack_require__.p + "./img/meredith_grey_small.png";
...
var _sideBarMenuReducer = __webpack_require__(103);

var _sideBarMenuReducer2 = _interopRequireDefault(_sideBarMenuReducer);

var _chatDirectoryReducer = __webpack_require__(104);

var _chatDirectoryReducer2 = _interopRequireDefault(_chatDirectoryReducer);

var _chatBoxReducer = __webpack_require__(105);

var _chatBoxReducer2 = _interopRequireDefault(_chatBoxReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var umbrellaApp = (0, _redux.combineReducers)({
  sideBarReducer: _sideBarMenuReducer2.default,
  chatDirectoryReducer: _chatDirectoryReducer2.default,
  chatBoxReducer: _chatBoxReducer2.default
});

exports.default = umbrellaApp;
...
module.exports = __webpack_require__.p + "./img/renee_collier.png";
